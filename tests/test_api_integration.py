...
class TestOrdersEndpoints:
    ...
    def test_get_order_success_200(self, admin_token):
        ...
        response = client.get("/orders/test-order-004",
                            headers={"Authorization": f"Bearer {admin_token}"})
    ...
    def test_get_order_not_found_404(self, admin_token):
        ...
        response = client.get("/orders/non-existent-order",
                            headers={"Authorization": f"Bearer {admin_token}"})
...
class TestDemoEndpoints:
    ...
    def test_mockbin_forbidden_403(self):
        ...
        user_response = client.post("/auth/login", data={
            "username": "user",
            "password": "user123"
        })
...
class TestCorrelationID:
    ...
    def test_correlation_id_with_auth(self):
        ...
        response = client.get("/orders/123", headers={
            "Authorization": f"Bearer {token}",
